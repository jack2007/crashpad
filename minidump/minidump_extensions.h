...
//!
//! \sa MINIDUMP_STRING
struct PACKED alignas(4) MinidumpUTF8String {
...
struct PACKED alignas(4) MinidumpByteArray {
...
struct PACKED alignas(4) MinidumpRVAList {
...
struct PACKED alignas(4) MinidumpSimpleStringDictionaryEntry {
...
struct PACKED alignas(4) MinidumpSimpleStringDictionary {
...
struct PACKED alignas(4) MinidumpAnnotation {
...
struct PACKED alignas(4) MinidumpAnnotationList {
...
struct PACKED alignas(4) MinidumpModuleCrashpadInfo {
...
//!     file.
struct PACKED alignas(4) MinidumpModuleCrashpadInfoLink {
...
//! structure.
struct PACKED alignas(4) MinidumpModuleCrashpadInfoList {
...
//! #version, so that newer parsers will be able to determine whether the added
//! fields are valid or not.
struct PACKED alignas(4) MinidumpCrashpadInfo {
